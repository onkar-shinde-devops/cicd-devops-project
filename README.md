# DevOps Project : Building an Automated CI/CD Pipeline for a Two-Tier Flask Application on AWS
...
### **1. Project Overview**
This project showcases an automated CI/CD pipeline for a two-tier Flask application with a MySQL backend on AWS EC2. The system uses Docker for containerization and Jenkins to automatically build and deploy the application on every GitHub push.

---


### **2. Infrastructure Diagram**
<img src="diagrams/img1.png">
...
1.  **Launch EC2 Instance:**
    ...
    * Select the **t2.small** instance type for free-tier eligibility.
    * Create and assign a new key pair for SSH access.

<img src="diagrams/img2.png">
...
<img src="diagrams/img7.png">

---

### **8. Conclusion**
The CI/CD pipeline is fully functional. Any push to the `main` branch triggers the Jenkins pipeline, which builds a new Docker image and deploys the updated application automatically, enabling a smooth and reliable deployment process.
